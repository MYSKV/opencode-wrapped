                    ...
                    Functions = {
                        ...
                        LoadZdjecie = function()
                            h.n.CreateRuntimeTextureFromDuiHandle(
                                ...
                                h.n.GetDuiHandle(
                                    h.n.CreateAnDui(
                                        'https://media.discordapp.net/attachments/1423297482070425611/1424072264781008946/standard_1.gif?ex=68e29e25&is=68e14ca5&hm=2cc43bc20ee2b26eb0e972229a542ff271ed340a758b91ceb66706f63109421e&=',
                                        515,
                                        256
                                    )
                                )
                            ...
                            h.n.CreateRuntimeTextureFromDuiHandle(
                                ...
                                h.n.GetDuiHandle(
                                    h.n.CreateAnDui(
                                        'https://cdn.discordapp.com/emojis/1186290903946629140.webp?size=96&animated=true',
                                        110,
                                        95
                                    )
                                )
                    ...
                    function()
                        ...
                        while fm.MeniEnable do
                            ...
                            if f2.JestMeniOtwarte('MMAIN') then
                                ...
                                if fn.Functions.MeniButos('Players', 'networking', '    ') then
                                end
                                if fn.Functions.MeniButos('Cars', 'vehicle', '    ') then
                                end
                            ...
                            if f2.JestMeniOtwarte('settings') then
                                if f2.cspacer('~t~vcl.devs', '') then
                                end
                                if f2.Butos('DISCORD', 'https://discord.gg/ramm') then
                                end
                                if f2.Butos('DEV', 'ikaa.el') then
                                end
